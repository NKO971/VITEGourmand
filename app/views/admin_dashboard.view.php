<div class="container-fluid my-4 admin-dashboard">
    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-lg-7">
            <div class="card shadow-sm h-100">
                <div class="card-header bg-white py-3">
                    <h2 class="card-title text-primary mb-0"><i class="bi bi-bar-chart me-2" aria-hidden="true"></i>Nombre de commandes par menu</h2>
                </div>
                <div class="card-body">
        ...
        <div class="col-12 col-lg-5">
            <div class="card shadow-sm h-100">
                <div class="card-header bg-white py-3">
                    <h2 class="card-title text-danger mb-0"><i class="bi bi-x-circle me-2" aria-hidden="true"></i>Annulations ce mois-ci</h2>
                </div>
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header bg-white py-3">
                    <h2 class="card-title text-success mb-0"><i class="bi bi-currency-euro me-2" aria-hidden="true"></i>Chiffre d'affaires</h2>
                </div>
                <div class="card-body">
