<div class="container-fluid my-4 gestion-employes">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <button class="btn btn-sm btn-outline-primary" id="btn-add-employe"><i class="bi bi-plus-circle me-1" aria-hidden="true"></i> Ajouter un employé</button>
    </div>

    <div class="card shadow-sm">
        <div class="card-header bg-white py-3">
            <h2 class="card-title text-primary mb-0"><i class="bi bi-people me-2" aria-hidden="true"></i>Comptes employés</h2>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <button class="btn btn-sm <?= ($employe['is_active'] ?? 0) == 1 ? 'btn-outline-danger' : 'btn-outline-success' ?> btn-toggle-employe"
                                            ...
                                            <i class="bi <?= ($employe['is_active'] ?? 0) == 1 ? 'bi-x-circle' : 'bi-check-circle' ?>" aria-hidden="true"></i>
