        ...
        <div class="modal-content">
            <form id="formEditMenu">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            <label for="edit_menu_min_personnes" class="form-label fw-semibold">Nombre de personnes minimum</label>
                            <input type="number" min="1" class="form-control" id="edit_menu_min_personnes" name="min_personnes" required>
                        </div>
                    </div>
                    <!-- Thème et Régime -->
                    ...
                    <div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label for="edit_delai_valeur" class="form-label fw-semibold">Délai de commande minimum</label>
                                <div class="input-group">
                                    <input type="number" class="form-control" id="edit_delai_valeur" placeholder="ex : 24" min="1" step="1">
                                    <select class="form-select" id="edit_delai_unite" style="max-width: 130px;">
